...
```{r}
m_rcbd_fixed <- glmmTMB(yield ~ gen + rep, 
                        data = dat)
...
url <- "https://raw.githubusercontent.com/k-state-id3a/mixed-models-fall26/refs/heads/newpart3/data/temperature_2.csv"
...
```{r}
url <- "https://raw.githubusercontent.com/k-state-id3a/mixed-models-fall26/refs/heads/newpart3/data/fecal_dm.csv"
