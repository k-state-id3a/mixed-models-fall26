...
# ggsave("../images/day1/attendees.jpg")
```
...
df_fig <- expand.grid(
  ...
  Block = 1:4)
df_fig$yhat <- predict(m1, newdata = df_fig)
...
df_n_ss %>% 
  ...
  theme_classic()
# ggsave("../images/day1/linearmodel1.jpg", width = 7, height = 5)
```
...
df_n_ss %>% 
  ...
  labs(x = expression(N~fertilizer~(lb~N~ac^{-1})), 
       y = expression(Yield~(kg~ha^{-1})))+
  theme_classic()
# ggsave("../images/day1/linearmodel2.jpg", width = 7, height = 5)
...
# ggsave("../images/day1/covmatrix_crd.jpg", width = 7, height = 5)
```
...
Z %*% G %*% t(Z) %>%
  ...
  theme(aspect.ratio = 1, 
        ...
        axis.title = element_blank(), 
        axis.ticks = element_blank())
# ggsave("../images/day1/covmatrix_rcbd.jpg", width = 7, height = 5)
```
...
# ggsave("../images/day1/emmeans_blocks.jpg", width = 6, height = 4)
```
...
# ggsave("../images/day1/shrinkage.jpg", width = 6, height = 2.5)
```
...
Z %*% G %*% t(Z) %>%
  ...
  theme(aspect.ratio = 1, 
        ...
        axis.title = element_blank(), 
        axis.ticks = element_blank())
# ggsave("../images/day1/figure_content_rcbd_varcov.jpg", width = 5, height = 6)
```
